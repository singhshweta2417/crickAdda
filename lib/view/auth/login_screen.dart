...
import 'package:crickAdda/view/auth/invite_code_bottom_sheet.dart';
...
import 'package:crickAdda/view_model/auth_view_model.dart';
                    ...
                    authProvider.state == AuthState.loading
                        ...
                        : ButtonConst(
                            label: AppLocalizations.of(context)!
                                .continueText
                                .toUpperCase(),
                            color: authProvider.isAbove18 &&
                                    authProvider.mobileNumberController.text
                                            .length ==
                                        10
                                ? AppColor.activeButtonGreenColor
                                : Colors.grey.shade100,
                            textColor: authProvider.isAbove18 &&
                                    authProvider.mobileNumberController.text
                                            .length ==
                                        10
                                ? AppColor.whiteColor
                                : Colors.grey,
                            onTap: () {
                              if (authProvider.isAbove18 &&
                                  authProvider
                                      .mobileNumberController.text.isNotEmpty &&
                                  authProvider
                                          .mobileNumberController.text.length ==
                                      10) {
                                authProvider.login(context).then((onValue) {
                                ...
                                Utils.showErrorMessage(context,
                                    "Please Enter Mobile Number and clarify terms.");
                              }
                            },
                          ),
                    Sizes.spaceHeight15,
