              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    optionSwitch(),
                    ContainerConst(
                        height: Sizes.screenHeight / 1.54, child: rewardShop())
                  ],
                ),
              ),
            )
        ...
        children: [
          ContainerConst(
            ...
            child: TextConst(
              text: "Reward Shop",
              fontWeight:
                  selectedTab == 0 ? FontWeight.w600 : FontWeight.normal,
          ...
          ContainerConst(
            ...
            child: TextConst(
              text: "My Rewards",
              fontWeight:
                  selectedTab == 1 ? FontWeight.w600 : FontWeight.normal,
  ...
  Widget rewardShop() {
    final List<Category> categories = [
      Category(
        ...
        offers: [
          Offer(
              title: '50% OFF: World Cup 2024 pass',
              price: 600,
              image:
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s"),
          Offer(
              title: '50% OFF: UAE T10 ICCA pass',
              price: 450,
              image:
                  "https://static.vecteezy.com/system/resources/thumbnails/021/688/074/small_2x/sports-football-stadium-blurred-background-ai-generated-image-photo.jpg"),
          Offer(
              title: '50% OFF: Premier League pass',
              price: 500,
              image:
                  "https://www.shutterstock.com/image-photo/blurred-field-lights-full-spectators-260nw-351081242.jpg"),
          Offer(
              title: '50% OFF: La Liga pass',
              price: 550,
              image:
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRfgHMu1-qLUhLthh7AVylktWcFX9Yg4oAhNy4NANWmXpsK-IvLEU_Syl3ccu2QYqZGjc&usqp=CAU"),
          Offer(
              title: '50% OFF: Serie A pass',
              price: 600,
              image:
                  "https://www.shutterstock.com/image-photo/blurred-field-lights-full-spectators-260nw-351081242.jpg"),
        ],
      ...
      Category(
        ...
        offers: [
          Offer(
              title: '50% OFF: Discount Pass (₹10 OFF)',
              price: 200,
              image:
                  "https://www.shutterstock.com/image-photo/blurred-field-lights-full-spectators-260nw-351081242.jpg"),
          Offer(
              title: '50% OFF: Discount Pass (₹25 OFF)',
              price: 500,
              image:
                  "https://static.vecteezy.com/system/resources/thumbnails/021/688/074/small_2x/sports-football-stadium-blurred-background-ai-generated-image-photo.jpg"),
          Offer(
              title: '50% OFF: Discount Pass (₹50 OFF)',
              price: 700,
              image:
                  "https://www.shutterstock.com/image-photo/blurred-field-lights-full-spectators-260nw-351081242.jpg"),
          Offer(
              title: '50% OFF: Discount Pass (₹75 OFF)',
              price: 900,
              image:
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s"),
          Offer(
              title: '50% OFF: Discount Pass (₹100 OFF)',
              price: 1000,
              image:
                  "https://www.shutterstock.com/image-photo/blurred-field-lights-full-spectators-260nw-351081242.jpg"),
        ],
      ...
      Category(
        ...
        offers: [
          Offer(
              title: '30% OFF: Champions League pass',
              price: 800,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '40% OFF: Wimbledon pass',
              price: 900,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '20% OFF: F1 Grand Prix pass',
              price: 1000,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '25% OFF: Tour de France pass',
              price: 1100,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '35% OFF: US Open pass',
              price: 1200,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
        ],
      ...
      Category(
        ...
        offers: [
          Offer(
              title: '50% OFF: Christmas pass',
              price: 300,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '45% OFF: New Year\'s Eve pass',
              price: 350,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '60% OFF: Easter pass',
              price: 400,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '55% OFF: Summer Vacation pass',
              price: 450,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
          Offer(
              title: '50% OFF: Winter Vacation pass',
              price: 500,
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvBEu85ap4V1VNeLYg_GRYmoRszNAHPdbCPA&s'),
        ],
