...
class FileUploadingOptionsBottomSheet extends StatefulWidget {
  ...
  @override
  State<FileUploadingOptionsBottomSheet> createState() =>
      _FileUploadingOptionsBottomSheetState();
}

class _FileUploadingOptionsBottomSheetState
    extends State<FileUploadingOptionsBottomSheet> {
  // File? _selectedFile;
  //
