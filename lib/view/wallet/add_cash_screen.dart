...
class AddCashScreen extends StatelessWidget {
  ...
  Widget bottomSheetContent(ProfileViewModel profileProvider) {
    return Consumer2<WalletViewModel, AddWalletViewModel>(
        builder: (context, walletProvider, addWalletSession, child) {
      return ContainerConst(
              ...
              children: [
                ...
                walletProvider.walletState == WalletState.loading
                    ...
                    : profileProvider.userProfile!.data!.isVerify == 1
                        ...
                        : ButtonConst(
                            onTap: () {
                              addWalletSession.addWalletSessionCreate(
                                  walletProvider.amount, context);
