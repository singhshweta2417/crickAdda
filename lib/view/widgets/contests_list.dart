                    ...
                    children: [
                        ...
                        trailing: Column(
                          ...
                          children: [
                            ...
                            contest.entry.toString() ==
                                    contest.my_joined_count.toString()
                                ? const SizedBox.shrink()
                                : contest.entryLimit == 'Single' &&
                                        contest.my_joined_count == 1
                                    ? const SizedBox.shrink()
                                    : contest.left_spot == 0
                                        ? const SizedBox.shrink()
                                        : ButtonConst(
                                            onTap: () async {
                                              if(time == null ||_isTimeValid(time)){
                                                contestProvider.setEnableJoinContestBottomSheet(true);contestProvider.setSelectedContestData(contest);
                                                await Provider.of<PlayerViewModel>(context, listen: false).getPlayers(context);
                                                if (Provider.of<PlayerViewModel>(
                                                    context,
                                                    listen: false)
                                                    .teamData!
                                                    .data!
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            TextConst(
                              text: contest.left_spot == 0
                                  ? 'Full'
                                  : "${contest.left_spot} spots left",
                              width: Sizes.screenWidth / 2.5,
                              alignment: Alignment.centerLeft,
