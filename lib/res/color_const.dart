...
class AppColor {
  ...
  static const Gradient lightToDarkRedGradient = LinearGradient(
      colors: [Color(0xff02367B), Color(0xff05014a)],
      begin: Alignment.centerLeft,
      end: FractionalOffset.centerRight,
      tileMode: TileMode.mirror);
  static const Gradient darkRedToBlackGradient = LinearGradient(
      colors: [Color(0xff02367B), AppColor.blackColor],
      begin: Alignment.centerLeft,
      end: FractionalOffset.centerRight,
      tileMode: TileMode.mirror);
  static const Gradient darkRedToBlackGradientTwo = LinearGradient(
      colors: [Color(0xff02367B), AppColor.blackColor, AppColor.blackColor],
      begin: Alignment.centerLeft,
      end: FractionalOffset.centerRight,
      tileMode: TileMode.mirror);
  ...
  static const Gradient blueGradient = LinearGradient(
      ...
      tileMode: TileMode.mirror);
  static const Gradient greenWhiteGradient = LinearGradient(
      colors: [
        Colors.white,
        Colors.white,
        Colors.white,
  ...
  static const Gradient greenWhiteGradient2 = LinearGradient(
      colors: [Colors.white, Colors.white, Color(0xffb3efc0)],
      begin: Alignment.centerLeft,
      end: FractionalOffset.centerRight,
      tileMode: TileMode.decal);
