...
import 'package:crickAdda/new_pages_by_harsh/model/single_player_details_model.dart';
import 'package:crickAdda/new_pages_by_harsh/my_contest/expension_tile.dart';
  ...
  ContainerConst topWhiteContainer(EdgeInsets constPadding) {
    ...
    if (dob.isNotEmpty) {
      try {
        ...
        print('Invalid date format for dob: $e');
      }
    }
    return ContainerConst(
      padding: constPadding,
